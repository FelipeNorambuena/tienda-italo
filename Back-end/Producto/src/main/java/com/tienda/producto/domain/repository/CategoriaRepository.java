...
/**
 * Repositorio de dominio para Categoria.
 * Define los contratos de acceso a datos para categorías.
 * 
...
public interface CategoriaRepository {
    ...
    // Búsquedas por fecha
    List<Categoria> findByCreatedAtAfter(java.time.LocalDateTime fecha);
    Page<Categoria> findByCreatedAtAfter(java.time.LocalDateTime fecha, Pageable pageable);
    List<Categoria> findByCreatedAtAfterAndActivaTrue(java.time.LocalDateTime fecha);
    Page<Categoria> findByCreatedAtAfterAndActivaTrue(java.time.LocalDateTime fecha, Pageable pageable);
    List<Categoria> findByUpdatedAtAfter(java.time.LocalDateTime fecha);
    Page<Categoria> findByUpdatedAtAfter(java.time.LocalDateTime fecha, Pageable pageable);
    List<Categoria> findByUpdatedAtAfterAndActivaTrue(java.time.LocalDateTime fecha);
    Page<Categoria> findByUpdatedAtAfterAndActivaTrue(java.time.LocalDateTime fecha, Pageable pageable);

    // Búsquedas por rango de fechas
    List<Categoria> findByCreatedAtBetween(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Categoria> findByCreatedAtBetween(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    ...
    List<Categoria> findByUpdatedAtBetween(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Categoria> findByUpdatedAtBetween(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    ...
    List<Categoria> findByCreatedAtBetweenAndDestacadaTrueAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Categoria> findByCreatedAtBetweenAndDestacadaTrueAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    List<Categoria> findByUpdatedAtBetweenAndDestacadaTrueAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Categoria> findByUpdatedAtBetweenAndDestacadaTrueAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);

    // Búsquedas de categorías por rango de fechas y padre
    List<Categoria> findByCreatedAtBetweenAndCategoriaPadreIsNullAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Categoria> findByCreatedAtBetweenAndCategoriaPadreIsNullAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    List<Categoria> findByCreatedAtBetweenAndCategoriaPadreIdAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Long categoriaPadreId);
    Page<Categoria> findByCreatedAtBetweenAndCategoriaPadreIdAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Long categoriaPadreId, Pageable pageable);
    List<Categoria> findByUpdatedAtBetweenAndCategoriaPadreIsNullAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Categoria> findByUpdatedAtBetweenAndCategoriaPadreIsNullAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    List<Categoria> findByUpdatedAtBetweenAndCategoriaPadreIdAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Long categoriaPadreId);
    Page<Categoria> findByUpdatedAtBetweenAndCategoriaPadreIdAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Long categoriaPadreId, Pageable pageable);
}
