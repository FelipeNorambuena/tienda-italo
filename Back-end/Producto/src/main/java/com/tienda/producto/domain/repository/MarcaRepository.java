package com.tienda.producto.domain.repository;
...
/**
 * Repositorio de dominio para Marca.
 * Define los contratos de acceso a datos para marcas.
 * 
...
public interface MarcaRepository {
    ...
    // Búsquedas por fecha
    List<Marca> findByCreatedAtAfter(java.time.LocalDateTime fecha);
    Page<Marca> findByCreatedAtAfter(java.time.LocalDateTime fecha, Pageable pageable);
    List<Marca> findByCreatedAtAfterAndActivaTrue(java.time.LocalDateTime fecha);
    Page<Marca> findByCreatedAtAfterAndActivaTrue(java.time.LocalDateTime fecha, Pageable pageable);
    List<Marca> findByUpdatedAtAfter(java.time.LocalDateTime fecha);
    Page<Marca> findByUpdatedAtAfter(java.time.LocalDateTime fecha, Pageable pageable);
    List<Marca> findByUpdatedAtAfterAndActivaTrue(java.time.LocalDateTime fecha);
    Page<Marca> findByUpdatedAtAfterAndActivaTrue(java.time.LocalDateTime fecha, Pageable pageable);

    // Búsquedas por rango de fechas
    List<Marca> findByCreatedAtBetween(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Marca> findByCreatedAtBetween(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    List<Marca> findByCreatedAtBetweenAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Marca> findByCreatedAtBetweenAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    List<Marca> findByUpdatedAtBetween(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Marca> findByUpdatedAtBetween(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    List<Marca> findByUpdatedAtBetweenAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Marca> findByUpdatedAtBetweenAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    ...
    List<Marca> findByCreatedAtBetweenAndDestacadaTrueAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Marca> findByCreatedAtBetweenAndDestacadaTrueAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    List<Marca> findByUpdatedAtBetweenAndDestacadaTrueAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Marca> findByUpdatedAtBetweenAndDestacadaTrueAndActivaTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    ...
    List<Marca> findByPaisAndCreatedAtBetweenAndActivaTrue(String pais, java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Marca> findByPaisAndCreatedAtBetweenAndActivaTrue(String pais, java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    List<Marca> findByPaisAndUpdatedAtBetweenAndActivaTrue(String pais, java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Marca> findByPaisAndUpdatedAtBetweenAndActivaTrue(String pais, java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    ...
    List<Marca> findByPaisAndCreatedAtBetweenAndDestacadaTrueAndActivaTrue(String pais, java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Marca> findByPaisAndCreatedAtBetweenAndDestacadaTrueAndActivaTrue(String pais, java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    List<Marca> findByPaisAndUpdatedAtBetweenAndDestacadaTrueAndActivaTrue(String pais, java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Marca> findByPaisAndUpdatedAtBetweenAndDestacadaTrueAndActivaTrue(String pais, java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
