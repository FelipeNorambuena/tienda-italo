 ...
 * Define los contratos de acceso a datos para productos.
 * 
...
public interface ProductoRepository {
    ...
    // Búsquedas por fecha
    List<Producto> findByCreatedAtAfter(java.time.LocalDateTime fecha);
    Page<Producto> findByCreatedAtAfter(java.time.LocalDateTime fecha, Pageable pageable);
    List<Producto> findByCreatedAtAfterAndActivoTrue(java.time.LocalDateTime fecha);
    Page<Producto> findByCreatedAtAfterAndActivoTrue(java.time.LocalDateTime fecha, Pageable pageable);
    List<Producto> findByUpdatedAtAfter(java.time.LocalDateTime fecha);
    Page<Producto> findByUpdatedAtAfter(java.time.LocalDateTime fecha, Pageable pageable);
    List<Producto> findByUpdatedAtAfterAndActivoTrue(java.time.LocalDateTime fecha);
    Page<Producto> findByUpdatedAtAfterAndActivoTrue(java.time.LocalDateTime fecha, Pageable pageable);
    ...
    List<Producto> findProductosRelacionados(Long productoId);
    Page<Producto> findProductosRelacionados(Long productoId, Pageable pageable);
    List<Producto> findProductosRelacionadosActivos(Long productoId);
    Page<Producto> findProductosRelacionadosActivos(Long productoId, Pageable pageable);

    // Búsquedas por atributos específicos
    List<Producto> findByAtributosNombreAndAtributosValor(String nombreAtributo, String valorAtributo);
    Page<Producto> findByAtributosNombreAndAtributosValor(String nombreAtributo, String valorAtributo, Pageable pageable);
    List<Producto> findByAtributosNombreAndAtributosValorAndActivoTrue(String nombreAtributo, String valorAtributo);
    Page<Producto> findByAtributosNombreAndAtributosValorAndActivoTrue(String nombreAtributo, String valorAtributo, Pageable pageable);
    ...
    List<Producto> findByCreatedAtBetween(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Producto> findByCreatedAtBetween(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    List<Producto> findByCreatedAtBetweenAndActivoTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Producto> findByCreatedAtBetweenAndActivoTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    List<Producto> findByUpdatedAtBetween(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Producto> findByUpdatedAtBetween(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
    List<Producto> findByUpdatedAtBetweenAndActivoTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin);
    Page<Producto> findByUpdatedAtBetweenAndActivoTrue(java.time.LocalDateTime fechaInicio, java.time.LocalDateTime fechaFin, Pageable pageable);
